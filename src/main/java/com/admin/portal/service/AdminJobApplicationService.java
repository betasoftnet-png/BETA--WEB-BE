    ...
    public JobApplication scheduleInterview(Long id, String dateStr, String timeStr, String linkStr) {
        ...
        try {
            ...
            String emailBody = "<!DOCTYPE html>\n" +
                    ...
                    + escapeHtml(savedApp.getEmail()) + "</span>\n" +
                    "            </td>\n" +
                    "          </tr>\n" +
                    "          <!-- Divider -->\n" +
                    "          <tr>\n" +
                    ...
                    +
                    "              <p style=\"margin: 0 0 24px 0;\">Dear <strong>" + escapeHtml(candidateName)
                    + "</strong>,</p>\n" +
                    "              <p style=\"margin: 0 0 24px 0;\">Congratulations!</p>\n" +
                    "              <p style=\"margin: 0 0 24px 0;\">We are pleased to inform you that you have successfully cleared the <strong>Test Round</strong> for the position of <strong>"
                    + escapeHtml(jobTitle)
                    + "</strong> and have progressed to the second stage of our recruitment process.</p>\n" +
                    ...
                    +
                    "                <p style=\"margin: 8px 0;\"><strong>Interview Date:</strong> " + dateFormatted
                    + "</p>\n" +
                    "                <p style=\"margin: 8px 0;\"><strong>Interview Time:</strong> " + timeFormatted
                    + "</p>\n" +
                    "                <p style=\"margin: 8px 0;\"><strong>Platform:</strong> Google Meet</p>\n" +
                    "                <p style=\"margin: 8px 0;\"><strong>Meeting Link:</strong> <a href=\""
                    + meetingLink + "\" style=\"color: #004AAD; text-decoration: underline;\">" + meetingLink
                    + "</a></p>\n" +
                    "              </div>\n" +
    ...
    public JobApplication saveHrInterview(Long id, String dateStr, String timeStr, String locationStr) {
        ...
        try {
            ...
            String emailBody = "<!DOCTYPE html>\n" +
                    ...
                    + "</strong>,</p>\n" +
                    "              <p style=\"margin: 0 0 24px 0;\">Congratulations!</p>\n" +
                    "              <p style=\"margin: 0 0 24px 0;\">We are pleased to inform you that we have reviewed your <strong>Task Assessment</strong> for the position of <strong>"
                    + escapeHtml(jobTitle)
                    + "</strong>. Based on your submission, you have been shortlisted for the <em>final stage (HR Round)</em> of our recruitment process.</p>\n"
                    +
                    ...
                    "                <p style=\"margin: 8px 0;\"><strong>Interview Time:</strong> " + timeFormatted
                    + "</p>\n" +
                    "                <p style=\"margin: 8px 0;\"><strong>Venue:</strong> <a href=\"" + mapsUrl
                    + "\" style=\"color: #004AAD; text-decoration: underline;\">" + locationFormatted + "</a></p>\n" +
                    "              </div>\n" +
                    "              <p style=\"margin: 24px 0 12px 0;\"><strong>Important Instructions :</strong></p>\n"
                    +
                    "              <ul style=\"margin: 0 0 24px 0; padding-left: 20px;\">\n" +

...
public class EmailService {
    ...
    public void sendTaskAssessmentEmail(JobApplication app, String taskDescription) {
        ...
        String body = "<!DOCTYPE html>\n" +
                ...
                "                Task Assessment:\n" +
                "              </p>\n" +
                "              <div style=\"background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 20px 24px; margin: 20px 0; font-family: inherit; font-size: 14px; white-space: pre-line; color: #334155; line-height: 1.6;\">\n" +
                ...
                "              </p>\n" +
                "              <div style=\"background-color: #fef2f2; border: 1px solid #fee2e2; border-radius: 8px; padding: 20px 24px; margin: 20px 0;\">\n" +

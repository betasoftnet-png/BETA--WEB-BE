...
public class EmailService {
    ...
    private String getAcceptanceEmailTemplate(String candidateName, String jobTitle) {
        ...
        return "<!DOCTYPE html>\n" +
                ...
                "              <p style=\"margin: 0 0 20px 0; font-size: 16px; line-height: 1.6; color: #374151; font-family: sans-serif;\">\n"
                +
                "                We are thrilled to inform you that your application for the <strong>"
                + escapeHtml(jobTitle)
                + "</strong> position has been <strong>accepted</strong>! We were highly impressed by your qualifications and interview performance.\n"
                +
                "              </p>\n" +
                "              \n" +
